...
async function main() {
    try {
        ...
        await contract.addContractListener('my-contract-listener', 'VoltusEvent', (err, event, blockNumber, transactionId, status) => {
            if (err) {
                console.error(err);
                return;
            }
            ...
            console.log('************************ VW Event Starts ************************************');

            console.log(event.vwobj);

            console.log('************************ VW Event Ends **************************************');
